/*****************************************************************************\
 ...
 @version:2.0 -20170726
 @author:liyonglu - yonglu518@qq.com;
 @description: 用于专属 接口开发做了优化调整；
...
//	var ns = "http://webservice.framework.javaWeb.com"
	// build SOAP request
	var sr =
    ...
    "<wsse:Security xmlns:wsse=\"http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd\" xmlns:wsu=\"http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-utility-1.0.xsd\">" +
     " <wsse:UsernameToken wsu:Id=\"UsernameToken-7215fbd3-f68d-4f33-afd7-3ee7621e61da\">" +
       " <wsse:Username>das_client</wsse:Username>" +
       " <wsse:Password Type=\"http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-username-token-profile-1.0#PasswordText\">das_2017</wsse:Password>" +
     " </wsse:UsernameToken>" +
    "</wsse:Security>" +
...
{
	var o = null;
	var nd = SOAPClient._getElementsByTagName(req.responseXML, method + "Return");
	if(nd.length == 0)
	{
